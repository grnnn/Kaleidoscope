...
public:
	...
	AActor* String_Actor__Get(FString Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	FString String_String__Get(FString Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	int32 String_Int__Get(FString Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	FVector String_Vector__Get(FString Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	FRotator String_Rotator__Get(FString Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	FVector Int_Vector__Get(int32 Key);
	
	/** Get the value associated with they key at fastest possible speed! <3 Rama */
	UFUNCTION(BlueprintPure,Category="VictoryBPLibrary|TMap Component|Get")
	float Int_Float__Get(int32 Key);
