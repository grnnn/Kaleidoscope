...
//~~~ Get ~~~
AActor* UVictoryTMapComp::String_Actor__Get(FString Key)
{
	return StringActor[Key];
}

FString UVictoryTMapComp::String_String__Get(FString Key)
{
	return StringString[Key];
}

int32 UVictoryTMapComp::String_Int__Get(FString Key)
{
	return StringInt[Key];
}

FVector UVictoryTMapComp::String_Vector__Get(FString Key)
{
	return StringVector[Key];
}
FRotator UVictoryTMapComp::String_Rotator__Get(FString Key)
{
	return StringRotator[Key];
}

FVector UVictoryTMapComp::Int_Vector__Get(int32 Key)
{
	return IntVector[Key];
}

float UVictoryTMapComp::Int_Float__Get(int32 Key)
{
	return IntFloat[Key];
}
